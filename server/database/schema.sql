...
-- Si MySQL Workbench da error de codificación, abre el archivo y guárdalo como UTF-8
CREATE DATABASE IF NOT EXISTS plataforma_cursos CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    tipo_usuario ENUM('instructor', 'estudiante', 'admin') DEFAULT 'estudiante',
...
CREATE TABLE IF NOT EXISTS lecciones (
    ...
    titulo VARCHAR(200) NOT NULL,
    descripcion TEXT,
    tipo_contenido ENUM('video', 'texto', 'recurso', 'enlace') DEFAULT 'video',
...
CREATE TABLE IF NOT EXISTS preguntas (
    ...
    tipo_pregunta ENUM('opcion_multiple', 'verdadero_falso', 'texto_libre') DEFAULT 'opcion_multiple',
...
CREATE TABLE IF NOT EXISTS recursos (
    ...
    tipo_recurso ENUM('archivo', 'enlace', 'video') DEFAULT 'archivo',
...
-- Tecnología Avanzada / Ingeniería
...
-- Matemáticas, Ciencia y Fundamentos Técnicos
...
-- ============================================
-- Este usuario se crea automáticamente al ejecutar este script
-- Credenciales de acceso:
--   Email: instructor@demo.com
--   Contraseña: instructor123
-- Hash bcrypt generado y verificado: $2a$10$9ZDB1rqKcE3SLkZJi9CMW.zC8g0Anw4qcTUOupSbcRYgAVjrjc5ku
-- ============================================
...
CREATE TABLE IF NOT EXISTS curso_insignias (
    ...
    UNIQUE KEY unique_curso_insignia (curso_id, insignia_id)
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
